...
def process_stream(
    ...
    for _, elem in context:
        ...
        print(f"[LOGGING] Finished processing page_id={page_id}, title={title}, revisions count={revision_count}")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Process Wikipedia XML.bz2 dump and extract clean revision text",
    ...
    parser.add_argument(
        ...
        type=int,
        default=100_000,
        help="Log progress every N revisions"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Process only first N pages (for debugging)"
    )
...
if __name__ == "__main__":
    ...
    stream = open_bz2_stream(args.input)
